...
public class Card4 : MonoBehaviour, ICardPattern
{
    [SerializeField] private string cardImagePath = "my_asset/Card4";
    [SerializeField] private string pattern16 = "0000111111110000";
