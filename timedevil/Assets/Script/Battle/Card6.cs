...
public class Card6 : MonoBehaviour, ICardPattern
{
    [SerializeField] private string cardImagePath = "my_asset/Card6";
    [SerializeField] private string pattern16 = "1111000000000000";
